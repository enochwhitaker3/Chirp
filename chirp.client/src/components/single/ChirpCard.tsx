...
const ChirpCard: FC<{ post: Post }> = ({ post }) => {
  return (
    <div className="flex flex-row mb-5 dark:bg-neutral-900 bg-neutral-300 w-[600px] max-w-[600px] dark:text-white text-black rounded-md h-fit pl-5 pt-5 cursor-pointer">
